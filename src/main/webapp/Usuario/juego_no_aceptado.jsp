...
<%JuegoPosteadoUsuario juegoPosteadoUsuario = (JuegoPosteadoUsuario) request.getAttribute("jueguito");%>
    ...
    <div class="row">
      <div class="col-12">
        <nav class="main-nav">
          ...
          <!-- ***** Menu Start ***** -->
          <ul class="nav">
            <li><a href="<%=request.getContextPath()%>/ServletTendencias"></a></li>
...
<div class="main-banner" style="padding: 140px">
  <div class="container">
    <form method="POST" action="<%=request.getContextPath()%>/ServletJuegoPosteado?p=actualizar">
      <input type="hidden" class="form-group" name="id_publicacion_usuario" id="id_publicacion_usuario">
    <div class="row">
      <div class="col-lg-6 align-self-center">
        <div class="caption header-text">
          <hr/>
          <h3 style="font-size: 35px"><%=juegoPosteadoUsuario.getNombre_juego_nuevo()%>: No aceptado </h3>
          <hr/>
        </div>
      </div>
    </div>
            ...
            <div class="form-group">
              <div class="row">
                <div class="col">
                  ...
                  <input type="text" class="form-control" id="precio" name="precio" value="<%=juegoPosteadoUsuario.getPrecio_venta_usuario()%>" readonly>
                </div>
                <div class="col">
                  <h5>Unidades:</h5>
                  <input type="number" class="form-control" id="unidades" name="unidades" value="3" readonly>
                </div>
                <div class="col">
                  <h5>Precio total:</h5>
        ...
        <div class="caption header-text">
          <div class="row">
            <div class="d-grid gap-2 mx-auto mb-3">
              <button type="submit" class="btn btn-secondary btn-block" onclick="window.location.href = '<%=request.getContextPath()%>/Proyectoiweb_war_exploded/ServletTendencias'">
          ...
          <div class="row">
            <div class="d-grid gap-2 mx-auto mb-3">
              <button class="btn btn-danger btn-lg" onclick="window.location.href = '<%=request.getContextPath()%>/Proyectoiweb_war_exploded/ServletTendencias'">Cancelar solicitud</button>
            </div>
          </div>
        </div>
      </div>
