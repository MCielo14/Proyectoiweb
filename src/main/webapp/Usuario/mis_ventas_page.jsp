                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="item" style="background-color: #FFE4E1">
                            ...
                            <div class="down-content">
                                ...
                                <td><a style="align-content: center; position: absolute; bottom: 20px" onclick="return confirm('Estas seguro de borrar :( ?')" class="btn btn-danger"
                                       href="<%=request.getContextPath()%>/ServletJuegoPosteado?a=borrar&id=<%=j.getId_publicacion_usuario()%>"><svg style="position: relative; bottom: 7px" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
